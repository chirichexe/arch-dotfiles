-- Converted from '01-default - v2.conf' for the Hyprland Lua config (0.55+).
...
hl.curve("nice", { type = "bezier", points = { { 0, 2 }, { 0.5, -1 } } })  -- clamped from 0, 6.9, 0.5, -4.20 (Lua limit is [-1, 2])
...
hl.animation({ leaf = "borderangle", enabled = true, speed = 100, bezier = "linear", style = "loop" })  -- clamped from 180 (max 100)
