-- Converted from 'Mahaveer - me-2.conf' for the Hyprland Lua config (0.55+).
...
hl.animation({ leaf = "borderangle", enabled = true, speed = 100, bezier = "liner", style = "loop" })  -- clamped from 180 (max 100)
