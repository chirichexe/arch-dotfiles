-- Converted from 'HYDE - optimized.conf' for the Hyprland Lua config (0.55+).
...
hl.curve("winOut", { type = "bezier", points = { { 0.2, -0.15 }, { 0, 1 } } })
...
hl.curve("OutBack", { type = "bezier", points = { { 0.28, 1.4 }, { 0.58, 1 } } })
