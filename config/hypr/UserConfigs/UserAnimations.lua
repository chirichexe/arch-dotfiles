...
hl.curve("nice", {
    type = "bezier",
    points = { { 0, 2.0 }, { 0.5, -1.0 } },  -- clamped from { 0, 6.9 }, { 0.5, -4.20 }
})
...
hl.animation({ leaf = "borderangle", enabled = true, speed = 100, bezier = "linear", style = "loop" })  -- clamped from 180
